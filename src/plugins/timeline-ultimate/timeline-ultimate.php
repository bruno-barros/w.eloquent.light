...
//require_once(plugin_dir_path(__FILE__) . 'themes/light/index.php');
...
//		wp_enqueue_style('timeline_um-style-flat', timeline_um_plugin_url . 'themes/flat/style.css');
	...
	else if ($timeline_um_themes == "light")
	{
//		require_once(plugin_dir_path(__FILE__) . 'themes/light/index.php');
//
//		// Style for themes
//		wp_enqueue_style('timeline_um-style-flat', timeline_um_plugin_url . 'themes/light/style.css');

		$timeline_um_display .= timeline_um_body_light($post_id);
	}
